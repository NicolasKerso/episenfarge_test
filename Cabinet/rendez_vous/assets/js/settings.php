            ...
            buttons: {
               save : function() {
                  ...
                  calEvent.id = $("#id_Red").val();
                   ...
                   calEvent.start = new Date(calEvent.start.getFullYear(), calEvent.start.getMonth(), calEvent.start.getDate(), startTime.getHours(), startTime.getMinutes(), startTime.getSeconds());
                   calEvent.end = new Date(calEvent.end.getFullYear(), calEvent.end.getMonth(), calEvent.end.getDate(), endTime.getHours(), endTime.getMinutes(), endTime.getSeconds());
   ...
   function setupStartAndEndTimeFields($startTimeField, $endTimeField, calEvent, timeslotTimes) {
      ...
      for (var i = 0; i < timeslotTimes.length; i++) {
         ...
         if (endTime.getTime() === calEvent.end.getTime()) {
          ...
          $startTimeField.append("<option value=\"" + startTime.toISOString() + "\" " + startSelected + ">" + timeslotTimes[i].start.toString().substr(16, 5) + "</option>");
          $endTimeField.append("<option value=\"" + endTime.toISOString() + "\" " + endSelected + ">" + timeslotTimes[i].end.toString().substr(16, 5) + "</option>");
